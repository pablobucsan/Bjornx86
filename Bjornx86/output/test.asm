...
Lstr0: db 116,114,117,101,0
Lstr1: db 102,97,108,115,101,0
Lstr2: db 48,98,0
Lstr3: db 48,98,0
Lstr4: db 48,98,0
Lstr5: db 48,120,0
...
Lstr7: db 48,120,0
Lstr8: db 48,120,0
Lstr9: db 120,32,61,32,37,104,104,117,44,32,115,32,61,32,37,115,10,0
section .text

; Extern functions 
extern ___get_rbp
extern _varg_start_u64
extern _putc_c
