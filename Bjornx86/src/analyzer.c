...
{   
    ...
    //print_ast(ast_counter_assignment, 0);
    /**
     * Type iterator;
     */
    ...
    ASTNode *lowered_foreach = makeBlock(lowered_foreach_statements, 3, 10);
...
Type *performUnaryOnType(Type *right, char *unary_op)
{
    ...
    switch(unary_code)
    {
        ...
        case UNARY_DEREF:{
            if (isTypeOfKind(right, TYPE_STR)){
                return createNumberTypeFromInfo(1,1, NUMBER_CHAR);
            }
