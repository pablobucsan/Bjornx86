...
#include "../../include/frontend/types.h"
#include <stdarg.h>
#include <stdlib.h>
#include <stdio.h>
...
char *fetchErrorMsgBasedOnErrorID(ErrorID e_id)
{
    switch(e_id)
    {
        ...
        case UNEXPECTED_TOKEN:{
            return "Unexpected character to tokenize. Got: '%c'.";
        }
        case UNSUPPORTED_ESC_SEQUENCE:{
        ...
        case EXPECTED_TKTYPE_NOT_MET:{
            return "Missing token type: '%s'. Instead got: '%s'.";
        }
        /** During analysis */
        ...
        case EXPECTED_OUTPUT_FILEPATH:{
            return "Expected output filepath after '-o' flag but got none.";
        }
        case UNKNOWN_FILE_EXT:{
            return "Unknown file extension for file: '%s'. Valid extensions are: '.bjo','.asm','.cub'.";
        }
        case INVALID_FILENAME:{
            return "Invalid input filename: '%s'.";
        }
